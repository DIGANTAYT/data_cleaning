...
import { BrainCircuit, Loader2, Sparkles, AlertCircle, ChevronDown, CheckCircle, TrendingUp } from 'lucide-react';
...
export function AutoML({ datasetId, columns, dataPreview }: AutoMLProps) {
  ...
  const handleTrain = async () => {
    ...
    if (credits < 70) {
      setResult({ error: '⚠️ Credit Limit Reached: You need at least 70 AI compute credits to train an AutoML model. Please go back to the Home page and upgrade to Analyst Lite or Data Scientist Pro to get fresh credits!' });
      return;
    }
